...
function sendConfigInterval() {
  client.publish(topic.value.replace("led", "configInterval"), TimeInterval.value.toString());
  console.log('Interval set ' + TimeInterval.value+ ' minutes');
}
